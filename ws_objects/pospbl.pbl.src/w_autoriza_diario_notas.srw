$PBExportHeader$w_autoriza_diario_notas.srw
$PBExportComments$Diario de Notas de Venta
forward
global type w_autoriza_diario_notas from window
end type
type cb_2 from commandbutton within w_autoriza_diario_notas
end type
type cb_1 from commandbutton within w_autoriza_diario_notas
end type
type st_1 from statictext within w_autoriza_diario_notas
end type
type sle_1 from singlelineedit within w_autoriza_diario_notas
end type
end forward
...
global w_autoriza_diario_notas w_autoriza_diario_notas

on w_autoriza_diario_notas.create
...
on w_autoriza_diario_notas.destroy
destroy(this.cb_2)
destroy(this.cb_1)
destroy(this.st_1)
destroy(this.sle_1)
...
event deactivate;w_rep_diario_notas.dw_1.setfocus()
end event
...
if ll_fun = 0 or isnull(ll_fun)  then
	...
	return -1
ELSE
  opensheet(w_rep_diario_notas,w_principal,1,layered!)	
