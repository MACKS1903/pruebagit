$PBExportHeader$w_rep_articulos.srw
$PBExportComments$Ventas de articulos
forward
global type w_rep_articulos from window
end type
type cb_4 from commandbutton within w_rep_articulos
end type
type cb_3 from commandbutton within w_rep_articulos
end type
type cb_salir from commandbutton within w_rep_articulos
end type
type cb_limpiar from commandbutton within w_rep_articulos
end type
type dw_articulo from datawindow within w_rep_articulos
end type
type dw_tipo from datawindow within w_rep_articulos
end type
type st_7 from statictext within w_rep_articulos
end type
type st_6 from statictext within w_rep_articulos
end type
type cb_2 from commandbutton within w_rep_articulos
end type
type cb_1 from commandbutton within w_rep_articulos
end type
type dw_cajas from datawindow within w_rep_articulos
end type
type st_2 from statictext within w_rep_articulos
end type
type st_1 from statictext within w_rep_articulos
end type
type em_hasta from editmask within w_rep_articulos
end type
type em_desde from editmask within w_rep_articulos
end type
type dw_1 from datawindow within w_rep_articulos
end type
type gb_1 from groupbox within w_rep_articulos
end type
end forward
...
global w_rep_articulos w_rep_articulos
...
open(w_autoriza_articulos)
li_fun = message.doubleparm
if li_fun > 0 then
   this.enabled= true
   dw_cajas.setfocus()	
elseif li_fun = 0 then
	close(w_rep_articulos)
	return
end if
end event
...
integer width = 2583
integer height = 1188
string dataobject = "d_rep_articulo"
