$PBExportHeader$w_rep_articulos_resumido_por_tipo.srw
$PBExportComments$Ventas de articulos
forward
global type w_rep_articulos_resumido_por_tipo from window
end type
type cb_3 from commandbutton within w_rep_articulos_resumido_por_tipo
end type
type cbx_1 from checkbox within w_rep_articulos_resumido_por_tipo
end type
type cb_salir from commandbutton within w_rep_articulos_resumido_por_tipo
end type
type cb_limpiar from commandbutton within w_rep_articulos_resumido_por_tipo
end type
type dw_articulo from datawindow within w_rep_articulos_resumido_por_tipo
end type
type dw_tipo from datawindow within w_rep_articulos_resumido_por_tipo
end type
type st_7 from statictext within w_rep_articulos_resumido_por_tipo
end type
type st_6 from statictext within w_rep_articulos_resumido_por_tipo
end type
type cb_2 from commandbutton within w_rep_articulos_resumido_por_tipo
end type
type cb_1 from commandbutton within w_rep_articulos_resumido_por_tipo
end type
type dw_cajas from datawindow within w_rep_articulos_resumido_por_tipo
end type
type st_2 from statictext within w_rep_articulos_resumido_por_tipo
end type
type st_1 from statictext within w_rep_articulos_resumido_por_tipo
end type
type em_hasta from editmask within w_rep_articulos_resumido_por_tipo
end type
type em_desde from editmask within w_rep_articulos_resumido_por_tipo
end type
type dw_1 from datawindow within w_rep_articulos_resumido_por_tipo
end type
type gb_1 from groupbox within w_rep_articulos_resumido_por_tipo
end type
end forward
...
global w_rep_articulos_resumido_por_tipo w_rep_articulos_resumido_por_tipo

type variables
int ii_nrcaja
long il_grupo,il_articulo
...
on w_rep_articulos_resumido_por_tipo.create
...
on w_rep_articulos_resumido_por_tipo.destroy
destroy(this.cb_3)
destroy(this.cbx_1)
...
elseif li_fun = 0 then
	close(w_rep_articulos_resumido_por_tipo)
	return
end if
end event
...
string text = "Con Factura"
boolean checked = true
borderstyle borderstyle = stylelowered!
end type

event clicked;if cbx_1.checked = true then
dw_1.dataobject='d_rep_articulo_resumido_por_tipo_no_nulo'
else
dw_1.dataobject='d_rep_articulo_resumido_por_tipo'
end if
...
integer width = 2583
integer height = 1188
string dataobject = "d_rep_articulo_resumido_por_tipo_no_nulo"
